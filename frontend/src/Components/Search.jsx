const Search = ({search,searchQuery,category}) => {
    return (
        <div className={`bg-light-grey flex items-center rounded-full border max-w-2xl w-full border-grey ${!search||category&&'hidden'} order-3 col-start-1 col-end-4 justify-self-center`}>
